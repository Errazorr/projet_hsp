...
function getMessages(){
  ...
  $resultats = $db->query("SELECT * FROM messages_patient ORDER BY created_at DESC LIMIT 20");
...
function postMessage(){
  ...
  $query = $db->prepare('INSERT INTO messages_patient SET author = :author, content = :content, created_at = NOW()');
