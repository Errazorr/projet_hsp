...
<html lang="fr-FR">
	<head>
		<meta charset="utf-8" />
		<title>Hopital Zoldyck - Chat</title>
		<style type="text/css">
	...
	<body>
		<div id="main-wrapper">
			<h1>Chat HxH : mini chat et mini forum instantané pour les membres!</h1>
			<p>Grâce à ce tchat, vous allez pouvoir discuter avec tous les membres de l'hôpital !</p>
			<hr />
			<?php
				if(!isset($_SESSION['id_utilisateur']))
				{
				?>
					<h2>Il s'agit d'une démo</h2>
