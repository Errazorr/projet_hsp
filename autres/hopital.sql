...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  lun. 07 déc. 2020 à 16:23
...
(5, 'Guo', 'Loic', 'g.loic@lprs.fr', '098f6bcd4621d373cade4e832627b4f6', 'admin');
...
(1, 'Aggoun', 'Aubervilliers', 'Neurologie', 'lucario@gmail.com', 'c1078f95440f31e9c88138226b1af484', 'oui', 'adam.jpg'),
(2, 'Guo', 'Bourget', 'Tabacologie', 'az@gmail.com', 'a9d3b34800d4283ed34b2bbbeb443a77', 'oui', 'gr.jpg'),
(3, 'Tang', 'Aulnay-sous-bois', 'Gynecologie', 'tang@gmail.fr', '87db92494758df7d0f0a4f39162a48f4', 'oui', 'fruit.jpg'),
(4, 'Birba', 'Dugny', 'Cardiologie', 'Enzo@gmail.fr', '098f6bcd4621d373cade4e832627b4f6', 'non', 'nami.jpg'),
(5, 'Testtt', 'Testtt', 'Testtt', 'Testtt@Testtt.Testtt', '08ddc922bcd99258d79a7452fd637254', 'non', 'cat.jpg'),
(6, 'Dauwe', 'Dugny', 'Generaliste', 'dauwe.marc@lprs.fr', '098f6bcd4621d373cade4e832627b4f6', 'oui', 'fruit.jpg');
...
CREATE TABLE IF NOT EXISTS `messages` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=74 DEFAULT CHARSET=utf8 COMMENT='La table qui va contenir tous les messages voyons !';
...
(73, 'Birba', 'hihi*', '2020-12-07 15:14:32');
...
(3, 'Fontaine', 'Ryan', '2000-10-12', 'ryan-fontaine@hotmail.fr', 'QQ', 'QQ', '232112321321312', 'QQ', 'QQ', '098f6bcd4621d373cade4e832627b4f6', 'patient', 'oui', NULL, 'Akatsuki.png'),
...
(2, 'Fontaine', 'Tang', '2020-12-11', '12:00:00', 'Douleurs');
