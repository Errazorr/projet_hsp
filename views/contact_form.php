                    ...
                    <form id="contact-form" method="post" action="" role="form">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="phone" type="tel" maxlength="10" name="phone" class="form-control" placeholder="Votre Téléphone">
                                <p class="comments"></p>
                            </div>
                            <div class="col-md-12">
                            ...
                            </div><br><center><a href="../index.php" style="color: red;" class="genric-btn danger-border circle arrow" style="font-family: Arial, sans-serif">Retour<span
